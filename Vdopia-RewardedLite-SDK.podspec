Pod::Spec.new do |s|
s.name         = "Vdopia-RewardedLite-SDK"
s.version      = "2.5.0.1"
...
s.author       = "Team"
s.platform     = :ios, "8.0"
s.source       = {:git => 'https://bitbucket.org/vdopia/iossdk-002/branch.git',:tag => '2.5.0.8'}
s.source_files  = "**/*.{h,m}",
s.resources = "**/*.{txt,js}"
...
s.vendored_frameworks = 'VDPMoatMobileAppKit.framework', 'AdColony.framework'
